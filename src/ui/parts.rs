...
/// Whether a chip's name is cut to [`CHIP_NAME_CHARS`] (`chars::elide`): what a chip asks
/// instead of measuring, its text being cut by the count and never by the room. The walk
/// stops at the cut rather than counting the whole name (`chars::byte_of_char`).
