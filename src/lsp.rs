...
//!
//! What a server is told about the project is `settings.rs`: what this app asks of every
//! server, and a project's own `.vscode/settings.json` laid over it. Nothing else here
//! reads a file.
//!
...
impl<W: Write + Send + 'static> Talk<W> {
    ...
    /// it.
    ///
    /// The options are the caller's: what this app asks of every server with whatever the
    /// project's own `.vscode/settings.json` said laid over it (`lsp/settings.rs`).
    ///
